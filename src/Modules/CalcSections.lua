...
{ 3, "Warcries", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Empowered Stats", data = {
	...
	{ label = "Empowered Attacks", haveOutput = "ExertedAttackUptimeRatio",
	  { format = "{2:output:ExertedAttackHitEffect}", { breakdown = "ExertedAttackHitEffect" }, },
	  { format = "{2:output:ExertedAttackAvgDmg}", { modName = "EmpoweredIncrease", cfg = "skill" }, },
	...
	{ label = "Boosted Attacks", bgCol = colorCodes.MAINHANDBG, haveOutput = "BoostedAttackUptimeRatio",
		{ format = "{2:output:BoostedAttackHitEffect}", { breakdown = "BoostedAttackHitEffect"}, },
		{ format = "{2:output:BoostedAttackAvgDmg}", { modName = "AncestralBoostDamage", cfg = "skill" }, { modName = "EmpoweredIncrease", cfg = "skill" } },
		{ format = "{0:output:BoostedAttackUptimeRatio}%", { breakdown = "BoostedAttackUptimeRatio" }, },
		{ format = "" },
		{ format = "{2:output:BoostedAttackMaxHitEffect}", { modName = "ExertIncrease", cfg = "skill" }, { modName = "ExertAttackIncrease", cfg = "skill" }, },
	},
	{ label = "AncestralEmpower+", bgCol = colorCodes.MAINHANDBG, haveOutput = "AncestralEmpowermentCombinedUptimeRatio",
	  ...
	  { format = "{2:output:AvgAncestralEmpowermentCombinedDamage}", { modName = { "AncestralEmpowermentDamageMultiplier", "FistOfWarDamageMultiplier" }, cfg = "skill" }, { modName = "AncestralBoostMoreDamage", cfg = "skill" }},
	...
	{ label = "Anc. Empowerment", bgCol = colorCodes.MAINHANDBG, haveOutput = "AncestralEmpowermentUptimeRatio",
	  ...
	  { format = "{2:output:AvgAncestralEmpowermentDamage}", { modName = "AncestralEmpowermentDamageMultiplier", cfg = "skill"}, { modName = "AncestralBoostMoreDamage", cfg = "skill" }},
	...
	{ label = "Ancestral Call", bgCol = colorCodes.MAINHANDBG, haveOutput = "AncestralCallUptimeRatio",
	  { format = "{2:output:AvgAncestralCallDamageEffect}", { breakdown = "AvgAncestralCallDamageEffect"}, },
	  { format = "{2:output:AvgAncestralCallDamage}", { modName = "AncestralCallDamageMultiplier", cfg = "skill"}},
	  { format = "{0:output:AncestralCallUptimeRatio}%", { breakdown = "AncestralCallUptimeRatio" },  },
	  { format = "" },
	  { format = "{2:output:MaxAncestralCallDamageEffect}" },
	},
} }
} },
...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Active Minion Limit", haveOutput = "ActiveMinionLimit", { format = "{0:output:ActiveMinionLimit}",
	  ...
	  { modName = { "ActiveMinionLimit" }, cfg = "skill" },
	}, },
	{ label = "Minion Revival Time", haveOutput = "MinionRevivalSpeed", { format = "{2:output:MinionRevivalSpeed}s", { breakdown = "MinionRevivalSpeed" }, { modName = { "MinionRevivalSpeed" } } },},
	...
	{ label = "Skill Cooldown", haveOutput = "Cooldown", { format = "{3:output:EffectiveCooldown}s",
		...
		{ modName = {"CooldownRecovery", "CooldownRecoveryFromTemporalis", "CooldownChanceNotConsume"}, cfg = "skill" },
	}, },
	...
	{ label = "Bounces Count", flag = "bounce", { format = "{output:BounceCount}", { modName = { "BounceCount", "ProjectileCount", "SurpassingProjectileChance", "TwoAdditionalProjectilesChance"  }, cfg = "skill" }, }, },
	{ label = "Aura Effect Mod", haveOutput = "AuraEffectMod", { format = "x {2:output:AuraEffectMod}",
		{ breakdown = "AuraEffectMod" },
		{ modName = { "AuraEffect", "SkillAuraEffectOnSelf", "Magnitude" }, cfg = "skill" },
	}, },
	...
	{ label = "Trap Cooldown", haveOutput = "TrapCooldown", { format = "{3:output:TrapCooldown}s",
		...
		{ modName = { "CooldownRecovery", "CooldownRecoveryFromTemporalis" }, cfg = "skill" },
	}, },
...
{ 1, "LeechGain", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Leech & Gain on Hit", data = {
	...
	{ label = "Mana Leech Rate", flag = "leechMana", notFlag = "showAverage", { format = "{1:output:ManaLeechRate}", 
		...
		{ label = "Leech Conversion", modName = { "ManaLeechBasedOnPhysicalDamage", "ManaLeechBasedOnColdDamage", "ManaLeechBasedOnFireDamage", "ManaLeechBasedOnLightningDamage", "ManaLeechBasedOnElementalDamage",  "ManaLeechBasedOnChaosDamage", "Condition:NoManaLeechFromPhysicalDamage", "Condition:NoManaLeechFromColdDamage", "Condition:NoManaLeechFromFireDamage", "Condition:NoManaLeechFromLightningDamage", "Condition:NoManaLeechFromElementalDamage", "Condition:NoManaLeechFromChaosDamage" }, cfg = "skill" }, 
	}, },
...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Freeze Buildup", haveOutput = "FreezeBuildupAvg", { format = "{1:output:FreezeBuildupAvg}%",
		{ breakdown = "FreezeBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyFreezeBuildup", "EnemyImmobilisationBuildup" }, cfg = "skill" },
		{ label = "Enemy modifiers", modName = { "PoiseThreshold", "EnemyFreezeThreshold", "FreezeBuildup", "ImmobilisationBuildup", "EnemyAilmentThreshold" }, enemy = true },
	}, },
	{ label = "Electrocute Buildup", haveOutput = "ElectrocuteBuildupAvg", { format = "{1:output:ElectrocuteBuildupAvg}%",
		{ breakdown = "ElectrocuteBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyElectrocuteBuildup", "EnemyImmobilisationBuildup" }, cfg = "skill" },
		{ label = "Enemy modifiers", modName = { "PoiseThreshold", "EnemyElectrocuteThreshold", "ElectrocuteBuildup", "ImmobilisationBuildup", "EnemyAilmentThreshold" }, enemy = true },
	}, },
	{ label = "Stun Buildup", haveOutput = "HeavyStunBuildupAvg", { format = "{1:output:HeavyStunBuildupAvg}%",
		{ breakdown = "HeavyStunBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyHeavyStunBuildup", "EnemyImmobilisationBuildup", "PhysicalHeavyStunBuildup" }, cfg = "skill" },
		{ label = "Enemy modifiers", modName = { "PoiseThreshold", "EnemyHeavyStunThreshold", "EnemyStunThreshold", "HeavyStunBuildup", "ImmobilisationBuildup", "StunBuildup" }, enemy = true },
	}, },
	{ label = "Pin Buildup", haveOutput = "PinBuildupAvg", { format = "{1:output:PinBuildupAvg}%",
...
{ 1, "MiscEffects", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Other Effects", data = {
	...
	{ label = "Culling Strike", haveOutput = "CullPercent", { format = "{2:output:CullPercent}%",
		{ breakdown = "CullingStrike" },
		{ modName = { "CullPercent", "CriticalCullPercent", cfg = "skill" } } ,
	}, },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Mind over Matter %", haveOutput = "AnySpecificMindOverMatter",
		...
		{ format = "+{0:output:PhysicalMindOverMatter}%",
			...
			{ modName = "DamageTakenFromManaBeforeLife", "PhysicalDamageTakenFromManaBeforeLife" },
		},
		...
		{ format = "+{0:output:ColdMindOverMatter}%",
			...
			{ modName = "DamageTakenFromManaBeforeLife", "ColdDamageTakenFromManaBeforeLife" },
		},
		{ format = "+{0:output:FireMindOverMatter}%",
			{ breakdown = "FireMindOverMatter" },
			{ modName = "DamageTakenFromManaBeforeLife", "FireDamageTakenFromManaBeforeLife" },
		},
	...
	{ label = "Hit Over Time Max.", haveOutput = "preventedLifeLossTotal", 
		{ format = "{0:output:LifeLossLostMax}",
			...
			{ modName = { "LifeLossPrevented", "LifeLossBelowHalfPrevented", "LifeLossLost", "LifeLossBelowHalfLost" } },
		},
	},
